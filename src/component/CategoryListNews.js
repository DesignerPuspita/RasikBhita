    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            ...
            // console.log('News Data:', newsDataResponse.recentEvents);
            // console.log('archive',newsDataResponse.allyears)
            if(newsDataResponse)
            {
      ...
      useEffect(()=>{
        const YearWiseDataFetch = async () =>{
          try{
            ...
            // console.log('testtt',typeof(isYear));
